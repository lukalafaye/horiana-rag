...
if not chroma_client_auth_provider or not chroma_client_auth_credentials:
    raise ValueError("Environment variables for ChromaDB authentication are not set correctly.")
if "." not in chroma_client_auth_provider:
    raise ValueError("The 'CHROMA_CLIENT_AUTHN_PROVIDER' should be a fully qualified class name.")
