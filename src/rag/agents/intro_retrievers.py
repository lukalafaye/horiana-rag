...
def title_retriever(llm, title, context_objectives, population, methods):
    ...
    details = build_details_string(context_objectives=context_objectives, population=population, methods=methods)
...
def abstract_background_retriever(llm, title, context_objectives, population, methods, abstracts_str):
    system = fetch_system_prompt(key="abstract_background_prompt", title=title)
    details = build_details_string(context_objectives=context_objectives, population=population, methods=methods, abstracts_str=abstracts_str)
...
def abstract_purpose_hypothesis_retriever(llm, title, context_objectives, population, methods):
    ...
    abstract_purpose_hypothesis_chain = abstract_purpose_hypothesis_prompt | llm | StrOutputParser()
    return abstract_purpose_hypothesis_chain.invoke({"system": system, "details": details})
...
def abstract_results_retriever(llm, title, context_objectives, population, methods, keyresults):
    system = fetch_system_prompt(key="abstract_results_prompt", title=title)
    details = build_details_string(context_objectives=context_objectives, population=population, methods=methods, keyresults=keyresults)
...
def abstract_conclusion_retriever(llm, title, context_objectives, population, methods, generated_keyresults):
    system = fetch_system_prompt(key="abstract_conclusion_prompt", title=title)
    details = build_details_string(context_objectives=context_objectives, population=population, methods=methods, keyresults=generated_keyresults)
...
def introduction_retriever(llm, title, context_objectives, population, methods, related_abstracts):
    system = fetch_system_prompt(key="introduction_prompt", title=title)
    details = build_details_string(context_objectives=context_objectives, population=population, methods=methods, related_abstracts=related_abstracts)
